package mikel.echeverria.Models;
...
public class Util {
    ...
    public static List<Mail> getDummyData() {
        return new ArrayList<Mail>() {{
            ...
            add(new Mail("Compra conjunta de camisetas", "Bueno, al final somos 10, vamos a pedir las camisetas que ya habíamos acordado. El pedido empezará al final del mes de Febrero, para entonces, si no has hecho la transferencia, no se procederá a pedir la tuya. Si necesitas los datos bancarios, avísame ;)", "carlos@gmail.com"));
            add(new Mail("Cursos 2021", "Cuñado, he visto unos cursos muy interesantes sobre programación. Pásate por mi casa hoy y le echamos un vistazo!", "rafael@gmail.com"));
            add(new Mail("Conferencia de lectores", "El lugar elegido para la conferencia de lectores internacional celebrada el día 29 de Febrero será en Pamplona. Visita nuestra página web para tener más detalles del evento.", "osvaldo@gmail.com"));
